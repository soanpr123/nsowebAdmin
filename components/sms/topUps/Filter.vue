<template>
    <div class="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-6 gap-4 items-end">
        <DateRangeFilter
        ...
        <SelectFilter
            ...
            label="Trạng thái"
            placeholder="Tất cả"
            :options="SMS_TOP_UP_STATUS_OPTIONS"
        />
        <SearchFilter
            query="searchContent"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                SMS_TOP_UP_STATUS_OPTIONS,
            };
        },

        computed: {
            ...mapState('sms/topUps', ['summary']),
        },
